...
| <a name="input_k8s_namespace"></a> [k8s\_namespace](#input\_k8s\_namespace) | The K8s namespace in which the kube-state-metrics service account has been created | `string` | `"kube-system"` | no |
